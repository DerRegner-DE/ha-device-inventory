...
/**
 * v2.5.0: Per-device installation photos with captions.
 ...
 *
 * v2.5.3: ``readOnly`` hides the upload form and per-thumb delete buttons.
 * DeviceDetail mounts read-only; the edit form mounts editable so all
 * mutating actions live in one place (user feedback from the forum).
 */
export function AttachmentsSection({
  ...
  // In read-only mode, suppress the whole section when there's nothing to
  // show — users don't need to see an empty "Einbauort-Bilder" heading on
